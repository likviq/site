...
namespace Quick_queue.Migrations
{
    ...
    partial class QuickQueueContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quick_queue.Models.Event", b =>
                {
            ...
            modelBuilder.Entity("Quick_queue.Models.Queue", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Quick_queue.Models.User", b =>
                {
                    b.Property<long>("idUser")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Quick_queue.Models.Event", b =>
                {
                    b.HasOne("Quick_queue.Models.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Quick_queue.Models.Queue", b =>
                {
                    b.HasOne("Quick_queue.Models.Event", "Event")
                        .WithMany()
                    ...
                    b.HasOne("Quick_queue.Models.User", "User")
                        .WithMany()
